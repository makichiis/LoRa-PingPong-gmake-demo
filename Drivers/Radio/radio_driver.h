 ...
 * \file      radio_driver.h
 *
 * \brief     STM32WL_SubGHz_Phy driver implementation FORK by makichiis
 *
 ...
 * 
 *                               _    _      _     _ _     
 *               _ __ ___   __ _| | _(_) ___| |__ (_|_)___ 
 *              | '_ ` _ \ / _` | |/ / |/ __| '_ \| | / __|
 *              | | | | | | (_| |   <| | (__| | | | | \__ \
 *              |_| |_| |_|\__,_|_|\_\_|\___|_| |_|_|_|___/
 *              (🄯) 2024 makichiis TRANS RIGHTS ARE HUMAN RIGHTS
 *                  
 *
 * \endcode
 *
 ...
 * 
 * \author    makichiis ( Somewhere on the internet ), July 2024.
 *
  ******************************************************************************
  *
  *          Portions COPYRIGHT 2020 STMicroelectronics
  *          COPYLEFT 2024 makichiis
  *
  * @file    radio_driver.h
  * @authors MCD Application Team, makichiis
...
// TODO: Refactor as enum if necessary and sensible
#define RFO_LP                                      1
#define RFO_HP                                      2
 ...
 */
typedef enum RadioStandbyModes_t
{
    STDBY_RC                                = 0x00,
    STDBY_XOSC                              = 0x01,
} RadioStandbyModes_t;
 ...
 */
typedef enum RadioRegularMode_t
{
 ...
 */
typedef enum RadioPacketTypes_t
{
 ...
 */
typedef enum RadioLoRaCadSymbols_t
{
 ...
 */
typedef enum RadioCadExitModes_t
{
    LORA_CAD_ONLY                           = 0x00,
    LORA_CAD_RX                             = 0x01,
    LORA_CAD_LBT                            = 0x10,
 ...
 */
typedef enum RadioModShapings_t
{
 ...
 * \brief Represents the modulation shaping parameter
 */
typedef enum RadioRxBandwidth_t
{
    RX_BW_4800                              = 0x1F,
    RX_BW_5800                              = 0x17,
    RX_BW_7300                              = 0x0F,
 ...
 */
typedef enum RadioLoRaSpreadingFactors_t
{
    LORA_SF5                                = 0x05,
    LORA_SF6                                = 0x06,
    LORA_SF7                                = 0x07,
 ...
 */
typedef enum RadioLoRaBandwidths_t
{
    LORA_BW_500                             = 6,
    LORA_BW_250                             = 5,
    LORA_BW_125                             = 4,
 ...
 */
typedef enum RadioLoRaCodingRates_t
{
    LORA_CR_4_5                             = 0x01,
    LORA_CR_4_6                             = 0x02,
    LORA_CR_4_7                             = 0x03,
 ...
 */
typedef enum RadioPreambleDetection_t
{
 ...
 */
typedef enum RadioAddressComp_t
{
 ...
 */
typedef enum RadioPacketLengthModes_t
{
 ...
 */
typedef enum RadioLoRaPacketLengthsMode_t
{
 ...
 */
typedef enum RadioLoRaRcrModes_t
{
 ...
 */
typedef enum RadioLoRaIQModes_t
{
    LORA_IQ_NORMAL                          = 0x00,
 ...
 */
typedef enum RadioTcxoCtrlVoltage_t
{
    TCXO_CTRL_1_6V                          = 0x00,
    TCXO_CTRL_1_7V                          = 0x01,
    TCXO_CTRL_1_8V                          = 0x02,
...
// begin packet data structures



// begin Modulation Parameters


/**
 * @brief Modulation parameters for GFSK packets.
 */
typedef struct GfskModulationParams_t {
    uint32_t                                BitRate;
    uint32_t                                Fdev;
...
/**
 * @brief Modulation parameters for BPSK packets.
 */
typedef struct BpskModulationParams_t {
    uint32_t                                BitRate;
    RadioModShapings_t                      ModulationShaping;
} BpskModulationParams_t;

/**
 * @brief Modulation parameters for LoRa packets.
 */
typedef struct LoRaModulationParams_t {
...
/**
 * @brief Modulation parameters for every radio packet type.
 * @todo Refactor this as a union.
 */
typedef struct ModulationParamsData_t {
    GfskModulationParams_t                  Gfsk;
    BpskModulationParams_t                  Bpsk;
    LoRaModulationParams_t                  LoRa;
} ModulationParamsData_t;

/*!
 * \brief The type describing the modulation parameters for every packet types
 */
typedef struct ModulationParams_t {
    RadioPacketTypes_t                      PacketType;
    ModulationParamsData_t                  Params;
} ModulationParams_t;


// end Modulation Parameters

// begin Packet Parameters


/**
 * @brief Packet data params for GFSK packets.
 */
typedef struct GfskPacketParams_t {
...
/**
 * @brief Packet data params for BPSK packets.
 */
typedef struct BpskPacketParams_t {
    uint8_t                                 PayloadLength;     //!< Size of the payload in the BPSK packet
} BpskPacketParams_t;

/**
 * @brief Packet data params for LoRa packets.
 */
typedef struct LoRaPacketParams_t {
...
typedef struct PacketParamsData_t {
    GfskPacketParams_t                      Gfsk;
    BpskPacketParams_t                      Bpsk;
    LoRaPacketParams_t                      LoRa;
} PacketParamsData_t;
...
typedef struct PacketParams_t {
    RadioPacketTypes_t                      PacketType;
    PacketParamsData_t                      Params;
} PacketParams_t;


// end Packet Parameters

// begin Packet Status


typedef struct GfskPacketStatus_t {
    uint8_t                                 RxStatus;
...
typedef struct LoRaPacketStatus_t {
...
typedef struct PacketStatusData_t {
...
// begin Calibration Params


/*!
 * \brief Represents a calibration configuration
 */
typedef union CalibrationParams_t
{
    struct CalibrationParamsBitFields_t
    {
 ...
 */
typedef union SleepParams_t
{
    struct SleepParamsFields_t
    {
 ...
 */
typedef union RadioError_t
{
    struct RadioErrorBitFields_t
    {
 ...
 */
typedef enum RadioOperatingModes_t
{
 ...
 */
void SUBGRF_SetDioIrqParams( 
    RadioIrqMasks_t irqMask, 
    RadioIrqMasks_t dio1Mask, 
    RadioIrqMasks_t dio2Mask, 
    RadioIrqMasks_t dio3Mask );
