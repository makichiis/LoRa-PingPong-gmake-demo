/**
  ******************************************************************************
  * @file    b_wl5m_subg_env_sensors_ex.c
...
/** @defgroup B_WL5M_SUBG_ENV_SENSOR_EX B-WL5M-SUBG ENV SENSOR EX
  * @{
  */

/** @defgroup B_WL5M_SUBG_ENV_SENSOR_EX_Imported_Variables B-WL5M-SUBG ENV SENSOR EX Imported Variables
  * @{
  */
...
/** @defgroup B_WL5M_SUBG_ENV_SENSOR_EX_Exported_Functions B-WL5M-SUBG ENV SENSOR EX Exported Functions
  * @{
  */
...
/**
  ...
  *         - ENV_PRESSURE or ENV_TEMPERATURE for instance ENV_SENSOR_ILPS22QS_0
