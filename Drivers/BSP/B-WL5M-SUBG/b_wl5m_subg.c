...
/** @addtogroup B_WL5M_SUBG_COMMON
  * @brief This file provides set of firmware functions to manage Leds, push-buttons
  *        and COM ports available on B-WL5M-SUBG board from STMicroelectronics.
  * @{
  */


/** @defgroup B_WL5M_SUBG_COMMON_Exported_Variables B-WL5M-SUBG COMMON Exported Variables
  * @{
  */
...
/** @defgroup B_WL5M_SUBG_COMMON_Private_Defines B-WL5M-SUBG COMMON Private Defines
  * @{
  */
...
/** @defgroup B_WL5M_SUBG_COMMON_Private_TypesDefinitions B-WL5M-SUBG COMMON Private Typedef
  * @{
  */
...
/** @defgroup B_WL5M_SUBG_COMMON_Private_Variables B-WL5M-SUBG COMMON Private Variables
  * @{
  */
...
/** @defgroup B_WL5M_SUBG_COMMON_Private_Functions B-WL5M-SUBG COMMON Private Functions
  * @{
  */
...
/** @addtogroup B_WL5M_SUBG_COMMON_Exported_Functions
  * @{
  */

/**
  * @brief  This method returns the B-WL5M-SUBG BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return ((int32_t)__B_WL5M_SUBG_BSP_VERSION);
}

/** @addtogroup B_WL5M_SUBG_COMMON_LED_Functions
  * @{
  */
...
/** @addtogroup B_WL5M_SUBG_COMMON_BUTTON_Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE > 0)
/** @addtogroup B_WL5M_SUBG_COMMON_COM_Functions B-WL5M-SUBG COMMON COM Functions
  * @{
  */
...
{
  /* USART configuration */
  huart->Instance          = COM_USART[(uint32_t)COM1];
...
/** @addtogroup B_WL5M_SUBG_COMMON_Private_Functions
  * @{
  */
